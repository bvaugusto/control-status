<template>
  <div>
    ...
    <vuetable ref="vuetable" api-url="https://control-status-back.herokuapp.com/public/api/machine" :fields="fields">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteRow(rowData) {
        Axios.delete("https://control-status-back.herokuapp.com/public/api/machine/" + rowData.id).then(
                function(response) {
